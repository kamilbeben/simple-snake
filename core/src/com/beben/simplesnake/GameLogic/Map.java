...
public class Map {
    ...
    private void initializeDickNowalls() {
        bricks = new Brick[52];
        bricks[0] = new Brick(brick_texture, new Position(78, 298));
        bricks[1] = new Brick(brick_texture, new Position(78, 310));
        bricks[2] = new Brick(brick_texture, new Position(78, 322));
        bricks[3] = new Brick(brick_texture, new Position(78, 334));
        bricks[4] = new Brick(brick_texture, new Position(78, 346));
        bricks[5] = new Brick(brick_texture, new Position(90, 178));
        bricks[6] = new Brick(brick_texture, new Position(90, 190));
        bricks[7] = new Brick(brick_texture, new Position(90, 202));
        bricks[8] = new Brick(brick_texture, new Position(90, 286));
        bricks[9] = new Brick(brick_texture, new Position(90, 298));
        bricks[10] = new Brick(brick_texture, new Position(90, 310));
        bricks[11] = new Brick(brick_texture, new Position(90, 322));
        bricks[12] = new Brick(brick_texture, new Position(90, 334));
        bricks[13] = new Brick(brick_texture, new Position(90, 346));
        bricks[14] = new Brick(brick_texture, new Position(90, 358));
        bricks[15] = new Brick(brick_texture, new Position(102, 166));
        bricks[16] = new Brick(brick_texture, new Position(102, 178));
        bricks[17] = new Brick(brick_texture, new Position(102, 190));
        bricks[18] = new Brick(brick_texture, new Position(102, 202));
        bricks[19] = new Brick(brick_texture, new Position(102, 214));
        bricks[20] = new Brick(brick_texture, new Position(102, 274));
        bricks[21] = new Brick(brick_texture, new Position(102, 286));
        bricks[22] = new Brick(brick_texture, new Position(102, 298));
        bricks[23] = new Brick(brick_texture, new Position(102, 310));
        bricks[24] = new Brick(brick_texture, new Position(102, 322));
        bricks[25] = new Brick(brick_texture, new Position(102, 334));
        bricks[26] = new Brick(brick_texture, new Position(102, 346));
        bricks[27] = new Brick(brick_texture, new Position(102, 358));
        bricks[28] = new Brick(brick_texture, new Position(114, 166));
        bricks[29] = new Brick(brick_texture, new Position(114, 202));
        bricks[30] = new Brick(brick_texture, new Position(114, 214));
        bricks[31] = new Brick(brick_texture, new Position(114, 226));
        bricks[32] = new Brick(brick_texture, new Position(114, 250));
        bricks[33] = new Brick(brick_texture, new Position(114, 262));
        bricks[34] = new Brick(brick_texture, new Position(126, 226));
        bricks[35] = new Brick(brick_texture, new Position(126, 238));
        bricks[36] = new Brick(brick_texture, new Position(126, 310));
        bricks[37] = new Brick(brick_texture, new Position(126, 322));
        bricks[38] = new Brick(brick_texture, new Position(126, 334));
        bricks[39] = new Brick(brick_texture, new Position(126, 346));
        bricks[40] = new Brick(brick_texture, new Position(138, 310));
        bricks[41] = new Brick(brick_texture, new Position(138, 322));
        bricks[42] = new Brick(brick_texture, new Position(150, 286));
        bricks[43] = new Brick(brick_texture, new Position(150, 298));
        bricks[44] = new Brick(brick_texture, new Position(162, 262));
        bricks[45] = new Brick(brick_texture, new Position(162, 274));
        bricks[46] = new Brick(brick_texture, new Position(174, 238));
        bricks[47] = new Brick(brick_texture, new Position(174, 250));
        bricks[48] = new Brick(brick_texture, new Position(186, 214));
        bricks[49] = new Brick(brick_texture, new Position(186, 226));
        bricks[50] = new Brick(brick_texture, new Position(198, 190));
        bricks[51] = new Brick(brick_texture, new Position(198, 202));
    }
